...
const footwear = [
  // SNEAKERS
  {
    ...
    image: "http://localhost:3000/src/assets/Converse Chuck Taylor All Star Madison Mid Lilac .jpg",
    brand: "Converse",
    colors: ["Lilac"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.8,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Converse Chuck Taylor All Star Lift Women's Platform High.jpg",
    brand: "Converse",
    colors: ["White", "Black"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.7,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Converse Womens Lift Hi Top Trainers.jpg",
    brand: "Converse",
    colors: ["White", "Pink"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.6,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Vans Caldrone Sneaker .jpg",
    brand: "Vans",
    colors: ["White", "Black"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.5,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Vans Unisex Old Skool Sherpa Trainers : Beige Rose Pink .jpg",
    brand: "Vans",
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Vans Womens Old Skool True White Shoes .jpg",
    brand: "Vans",
    colors: ["White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.8,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Vans Sk8 Hi .jpg",
    brand: "Vans",
    colors: ["Black", "White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.6,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Adidas Originals Campus 00s.jpg",
    brand: "Adidas",
    colors: ["White", "Green"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.7,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Adidas Campus Sneakers.jpg",
    brand: "Adidas",
    colors: ["White", "Blue"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.5,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Pink adidas sambas.jpg",
    brand: "Adidas",
    colors: ["Pink"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.8,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Calvin Klein Jeans Sneaker in Weiß.jpg",
    brand: "Calvin Klein",
    colors: ["White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.6,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Calvin Klein Shoes | Calvin Klein Sneakers Aubrie White Logo Low Top Trainers .jpg",
    brand: "Calvin Klein",
    colors: ["White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.7,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Zapatillas CALVIN KLEIN en color bright white black para caballero .jpg",
    brand: "Calvin Klein",
    colors: ["White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.5,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Replica Louis Vuitton White:Pink Time Out Sneakers .jpg",
    brand: "Louis Vuitton",
    colors: ["Pink", "White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.9,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Replica Louis Vuitton White:Gold Time Out Sneakers .jpg",
    brand: "Louis Vuitton",
    colors: ["Gold", "White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.9,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Women's Luxury Trainers LOUIS VUITTON .jpg",
    brand: "Louis Vuitton",
    colors: ["White", "Black"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 5.0,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Louis Vuitton Shoes  Lv Trainer Sneaker .jpg",
    brand: "Louis Vuitton",
    colors: ["White", "Black"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.9,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Nike airforce shadow.jpg",
    brand: "Nike",
    colors: ["White", "Gray"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.7,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Nike Dunk Low Pink Paisley Sneakers .jpg",
    brand: "Nike",
    colors: ["Pink", "White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.8,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Nike Panda Dunks Shoe .jpg",
    brand: "Nike",
    colors: ["Black", "White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.9,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/Nike Classic Cortez Women's Leather Sneakers.jpg",
    brand: "Nike",
    colors: ["White", "Red"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.6,
  ...
  // HEELS
  {
    ...
    image: "http://localhost:3000/src/assets/heels/Sloyan High Heel Sandal in Gold .jpg",
    brand: "Sloyan",
    colors: ["Gold"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.5,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/heels/Steve Madden Eryka Ankle Strap Sandal in Multi Leather at Nordstrom Rack.jpg",
    brand: "Steve Madden",
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/heels/Luxury fashion & independent designers .jpg",
    brand: "Luxury",
    colors: ["Black", "Red"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.8,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/heels/JYPSEY Tan Leather Strappy Stiletto Women's Heel .jpg",
    brand: "JYPSEY",
    colors: ["Tan"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.6,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/heels/Milooey shoes Women Elegant Open Toe Strappy Heeled Sandal Lace Up Block High Heels Ankle Strap.jpg",
    brand: "Milooey",
    colors: ["Black", "White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.5,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/heels/Chalk Oleana Clear Trapeze Heel .jpg",
    brand: "Chalk",
    colors: ["Clear"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.7,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/heels/Jimmy Choo us.jpg",
    brand: "Jimmy Choo",
    colors: ["Black", "Gold"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.9,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/heels/Steve Madden Manzie Heeled Sandal Women's Shoes White Zappos.jpg",
    brand: "Steve Madden",
    colors: ["White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.6,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/heels/ANNIE White Women's Strappy Square Toe Heel .jpg",
    brand: "ANNIE",
    colors: ["White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.5,
  ...
  // FLATS
  {
    ...
    image: "http://localhost:3000/src/assets/flats/Black Roxane Slingback Mary Jane Flats | CHARLES & KEITH.jpg",
    brand: "Charles & Keith",
    colors: ["Black"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.6,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/flats/White Products by Louis Vuitton- LV Sunset Flat Comfort Sandal.jpg",
    brand: "Louis Vuitton",
    colors: ["White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.9,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/flats/ODYSSEY Natural Strappy Square-Toe Flats.jpg",
    brand: "ODYSSEY",
    colors: ["Natural"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.4,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/flats/Beach Wedding Flats.jpg",
    brand: "Beach Wedding",
    colors: ["White", "Ivory"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.3,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/flats/Linear Black Suede Flats.jpg",
    brand: "Linear",
    colors: ["Black"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.5,
  ...
  },
  {
    ...
    image: "http://localhost:3000/src/assets/flats/BABUDOG Womens Flats Shoes with Pomegranate Embroidery,White Flats with Bow,Comfortable Round-Toe Flats Shoes.jpg",
    brand: "BABUDOG",
    colors: ["White"],
    sizes: ["5", "6", "7", "8", "9", "10"],
    rating: 4.7,
