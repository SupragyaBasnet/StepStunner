...
// Heels
import sloyanHighHeel from "../assets/Sloyan High Heel Sandal in Gold .jpg";
import steveMaddenEryka from "../assets/Steve Madden Eryka Ankle Strap Sandal in Multi Leather at Nordstrom Rack.jpg";
import luxuryFashion from "../assets/Luxury fashion & independent designers .jpg";
import jypseyTan from "../assets/JYPSEY Tan Leather Strappy Stiletto Women's Heel .jpg";
import milooeyShoes from "../assets/Milooey shoes Women Elegant Open Toe Strappy Heeled Sandal Lace Up Block High Heels Ankle Strap.jpg";
import chalkOleana from "../assets/Chalk Oleana Clear Trapeze Heel .jpg";
import jimmyChoo from "../assets/Jimmy Choo us.jpg";
import steveMaddenManzie from "../assets/Steve Madden Manzie Heeled Sandal Women's Shoes White Zappos.jpg";
import annieWhite from "../assets/ANNIE White Women's Strappy Square Toe Heel .jpg";
...
export const getFootwearByCategory = (category: string) => {
  return footwear.filter(item => item.subcategory === category);
};

export const getFootwearByBrand = (brand: string) => {
  return footwear.filter(item => item.brand === brand);
};

export const getSneakers = () => {
  return footwear.filter(item => item.subcategory === "sneakers");
};

export const getHeels = () => {
  return footwear.filter(item => item.subcategory === "heels");
}; 